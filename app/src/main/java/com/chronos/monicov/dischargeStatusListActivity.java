...
public class dischargeStatusListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_discharge_status_list);

        mAuth = FirebaseAuth.getInstance();

        ArrayAdapter<String> dayListAdapter = new ArrayAdapter<>(dischargeStatusListActivity.this, android.R.layout.simple_list_item_1, daysList);
        ...
        daysListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(chosenDay.equals("Initial Screening")){
                    startActivity(new Intent(dischargeStatusListActivity.this, patientStatusInitialActivity.class));
                }
                else{
