...
public class acquaintancePatientDayListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acquaintance_day_list);

        String email = getIntent().getStringExtra("qrEmail").toString();
        mAuth = FirebaseAuth.getInstance();

        ArrayAdapter<String> dayListAdapter = new ArrayAdapter<>(acquaintancePatientDayListActivity.this, android.R.layout.simple_list_item_1, daysList);
        ...
        daysListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent passData = new Intent(getBaseContext(), acquaintancePatientStatusActivity.class);
