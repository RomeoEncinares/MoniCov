...
public class medicalProfessionalPatientStatusInitialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_professional_patient_status_initial);
        ...
        String chosenPatient = getIntent().getStringExtra("email").toString();
